...
#
  set src_file        = /scratch/e14/rmh561/mom/input/gyre1/ocean_temp_salt.res.nc   # source data file
  set dest_grid       = $cwd:h/generate_grids/ocean/workdir/grid_spec.nc  # destination grid
